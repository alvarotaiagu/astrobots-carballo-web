/* Hojas de contacto de Pexels para elegir fotografia a mano (Astrobots).
...
const CONSULTAS = process.argv.slice(2).length ? process.argv.slice(2) : [
  'hands assembling robot kit table',
  'electronic components arduino cables desk flat lay',
  'laptop screen block coding scratch kids classroom no faces',
  '3d printer printing close up',
  'vinyl cutter plotter machine',
  'robot arm educational toy wheels gears',
  'bright classroom window desks empty',
  'lego technic gears macro',
];
